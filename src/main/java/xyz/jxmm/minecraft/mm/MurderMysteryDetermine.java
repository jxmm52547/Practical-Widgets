...
public class MurderMysteryDetermine {
    ...
    public static boolean deaths(JsonObject jsonObject) {
        return jsonObject.has("deaths");
    }
    ...
    public static boolean was_hero(JsonObject jsonObject) {
        return jsonObject.has("was_hero");
    }

    public static boolean coins_pickedup(JsonObject jsonObject) {
        return jsonObject.has("coins_pickedup");
    }
    ...
    //经典模式
    public static boolean games_MURDER_CLASSIC(JsonObject jsonObject) {
        return jsonObject.has("games_MURDER_CLASSIC");
    }

    public static boolean wins_MURDER_CLASSIC(JsonObject jsonObject) {
        return jsonObject.has("wins_MURDER_CLASSIC");
    }

    public static boolean bow_kills_MURDER_CLASSIC(JsonObject jsonObject) {
        return jsonObject.has("bow_kills_MURDER_CLASSIC");
    }
    ...
    public static boolean was_hero_MURDER_CLASSIC(JsonObject jsonObject) {
        return jsonObject.has("was_hero_MURDER_CLASSIC");
    }
